...
struct TextFormatting {
    static let blackHeader: [NSAttributedString.Key : Any] = [.font: UIFont.systemFont(ofSize: 16, weight: .medium), .foregroundColor:  UIColor.blackColor]
    static let blackRegularTitle: [NSAttributedString.Key : Any] = [.font: UIFont.systemFont(ofSize: 14, weight: .regular), .foregroundColor:  UIColor.blackColor]
    static let blackMediumTitle: [NSAttributedString.Key : Any] = [.font: UIFont.systemFont(ofSize: 14, weight: .medium), .foregroundColor:  UIColor.blackColor]
    static let grayValue: [NSAttributedString.Key : Any] = [.font: UIFont.systemFont(ofSize: 14, weight: .regular), .foregroundColor:  UIColor.grayColor]
